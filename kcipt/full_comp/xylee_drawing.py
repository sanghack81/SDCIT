...
names = {('CHSIC', 'chaotic'): names_chsic_chaotic,
         ...
         ('XYLEE', 'chaotic'): names_lee_chaotic,
         ('SDCIT', 'postnonlinear'): names_lee_postnonlinear,
         ('XYLEE', 'postnonlinear'): names_lee_postnonlinear,
...
pvalue_column = {'CHSIC': 'pvalue', 'KCIT': 'boot_p_value', 'SDCIT': 'pvalue', 'adj_kcipt': 'pvalue', 'KCIPT': 'pvalue', 'XYLEE':'pvalue'}

cp = sns.color_palette('Set1', 5)
cps = {'CHSIC': 3, 'KCIT': 2, 'SDCIT': 0, 'XYLEE': 4, 'KCIPT': 1}
all_algos = ['SDCIT', 'KCIT', 'XYLEE']
...
def draw_aupc_chaotic():
    ...
    sns.despine()
    plt.savefig('xylee_{}_aupc.pdf'.format(data), transparent=True, bbox_inches='tight', pad_inches=0.02)
    plt.close()
...
def draw_calib_chaotic():
    ...
    sns.despine()
    plt.savefig('xylee_chaotic_calib.pdf', transparent=True, bbox_inches='tight', pad_inches=0.02)
    plt.close()
...
def draw_Type_I_error_chaotic():
    ...
    sns.despine()
    plt.savefig('xylee_chaotic_type_I.pdf', transparent=True, bbox_inches='tight', pad_inches=0.02)
    plt.close()
...
def draw_aupc_postnonlinear():
    ...
    sns.despine()
    plt.savefig('xylee_postnonlinear_aupc.pdf', transparent=True, bbox_inches='tight', pad_inches=0.02)
    plt.close()
...
def draw_aupc_postnonlinear_highdim():
    ...
    # plt.title('Postnonlinear')
    sns.despine()
    plt.savefig('xylee_postnonlinear_aupc_highdim.pdf', transparent=True, bbox_inches='tight', pad_inches=0.02)
    plt.close()
...
def draw_calib_postnonlinear():
    ...
    # plt.title('Postnonlinear')
    sns.despine()
    plt.savefig('xylee_postnonlinear_calib.pdf', transparent=True, bbox_inches='tight', pad_inches=0.02)
    plt.close()
...
def draw_calib_postnonlinear_highdim():
    ...
    # plt.title('Postnonlinear')
    sns.despine()
    plt.savefig('xylee_postnonlinear_calib_highdim.pdf', transparent=True, bbox_inches='tight', pad_inches=0.02)
    plt.close()
...
def draw_type_I_postnonlinear_highdim():
    ...
    # plt.title('Postnonlinear')
    sns.despine()
    plt.savefig('xylee_postnonlinear_type_I_highdim.pdf', transparent=True, bbox_inches='tight', pad_inches=0.02)
    plt.close()
