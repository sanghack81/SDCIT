...
def FCIT_K(KX, KY, KZ=None, eq_17_as_is=True, with_gp=True, sigma_squared=1e-3, seed=None, hsic_kws={}):
...
def FCIT(X, Y, Z=None, kern=rbf_kernel_with_median_heuristic, normalize=False, seed=None, hsic_kw={}):
    """Flaxman et al. Residualization-based CI Test, X_||_Y | Z"""
    if seed is not None:
        np.random.seed(seed)
